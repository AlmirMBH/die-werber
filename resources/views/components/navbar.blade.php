    ...
    <div id="menu" class=" w-full sm:w-auto self-end sm:self-center sm:flex flex-col sm:flex-row items-center h-full sm:py-0 sm:pb-0 hidden">
        <ul class="menu-items pt-6">
            ...
            <li><a href="">Shops<span class="arrow arrowDown"></span></a>
                <ul class="sub">
                    <li><a href="https://schutzmasken.die-werber.ch" rel=”nofollow” target="_blank">Masks</a></li>
                    <li><a href="https://die-werber.ch/wp-content/uploads/2021/04/Katalog-2021.pdf" rel=”nofollow” target="_blank">Merchandising</a></li>
                </ul>
            </li>
